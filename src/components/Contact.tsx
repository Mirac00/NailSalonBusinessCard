...
const contactInfo = [
  {
    icon: MapPin,
    title: 'Adres',
    details: ['ul. PiÄ™kna 15', '00-549 Warszawa'],
  },
  {
    icon: Phone,
    title: 'Telefon',
  ...
  },
  {
    ...
    details: ['Pn-Pt: 10:00 - 20:00', 'Sb: 10:00 - 18:00', 'Nd: zamkniÄ™te'],
  },
];
    ...
    <section ref={ref} className="py-20 px-4 bg-gradient-to-b from-pink-50 to-white">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600">Skontaktuj siÄ™ z nami i umĂłw wizytÄ™</p>
        </motion.div>
        ...
        >
          <h3 className="text-3xl mb-8 text-gray-800 text-center">UmĂłw wizytÄ™</h3>
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-gray-700 mb-2">ImiÄ™ i nazwisko</label>
                <input
                  type="text"
            ...
            <div>
              <label className="block text-gray-700 mb-2">Wybierz usĹ‚ugÄ™</label>
              <select className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-400">
                ...
                <option>PrzedĹ‚uĹĽanie paznokci</option>
              </select>
            </div>
            <div>
              <label className="block text-gray-700 mb-2">WiadomoĹ›Ä‡</label>
              <textarea
                rows={4}
                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-400"
